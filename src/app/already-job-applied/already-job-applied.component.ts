...
@Component({
  selector: 'app-already-job-applied',
  templateUrl: './already-job-applied.component.html',
  styleUrls: ['./already-job-applied.component.css']
})
export class AlreadyJobAppliedComponent implements OnInit {
  ...
  getRecommendJobs() {
   // let jobId =  0;
   debugger;
    let jobId =  205637 //localStorage.getItem('mailJobId') ? localStorage.getItem('mailJobId') : 0;
