...
@Component({
  selector: 'app-thanks-for-joining',
  templateUrl: './thanks-for-joining.component.html',
  styleUrls: ['./thanks-for-joining.component.css']
})
export class ThanksForJoiningComponent implements OnInit {
