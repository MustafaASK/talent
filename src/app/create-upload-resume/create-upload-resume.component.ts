...
@Component({
  selector: 'app-create-upload-resume',
  templateUrl: './create-upload-resume.component.html',
  styleUrls: ['./create-upload-resume.component.css']
})
export class CreateUploadResumeComponent implements OnInit {
  ...
  addressLineDataPass($event: any) {
    console.log($event);
    this.addressLineStatus = false;
    if ($event == "VALID") {
      this.addressLineStatus = true;
    }
    // this.addressLineStatus = $event;

  }

  APTDataPass($event: any) {
    console.log($event);
    this.APTStatus = false;
    if ($event == "VALID") {
      this.APTStatus = true;
    }
    // this.APTStatus = $event;

  }

  cityDataPass($event: any) {
    console.log($event);
    this.cityStatus = false;
    if ($event == "VALID") {
      this.cityStatus = true;
    }
    // this.cityStatus = $event;

  }

  stateDataPass($event: any) {
    console.log($event);
    this.stateStatus = false;
    if ($event == "VALID") {
      this.stateStatus = true;
    }
    // this.stateStatus = $event;

  }

  countryDataPass($event: any) {
    console.log($event);
    this.countryStatus = false;
    if ($event == "VALID") {
      this.countryStatus = true;
    }
    // this.countryStatus = $event;

  }

  zipcodeDataPass($event: any) {
    console.log($event);
    this.zipcodeStatus = false;
    if ($event == "VALID") {
      this.zipcodeStatus = true;
    }
    // this.zipcodeStatus = $event;
  ...
  getreviewdetails() {
    ...
    this.userService.getreviewdetails().subscribe((response: any) => {
      ...
      if (response && response.Success) {
        ...
        this.candData.address = location.join(', ');
        ...
        this.candData.apt = this.auditlogService.decryptAES(response.contactInfoList[0].apt);
  ...
  onSelectFile(event: any, element: any) {
    ...
    dialogRef.afterClosed().subscribe(dialogResult => {
      ...
      if (this.deleteconfirmresult) {
        ...
        this.staticAuditLogAPI('14', JSON.stringify(fileobj));
  ...
  updateCandData(obj: any) {
    ...
    if (obj.name == 'basicInfo') {
      ...
      this.candData.careersummary = this.removeJunk.addBreaks(obj.careerSummary);
  ...
  createResumeBuilderForm() {
    ...
    else if (this.candData.address.trim() == '') {
      this.toastr.error('Please enter Address Line 1.');
      // if (this.keywordsInput.basicInfoFormObj.controls['address'].invalid) {
      const addresscontrol = this.el.nativeElement.querySelector('[formcontrolname="' + "address" + '"]');
      addresscontrol.focus();
      // }
      window.scrollTo(0, 0); // this will scroll page to the top
      return;
    }
    else if (this.candData.apt.trim() == '') {
      this.toastr.error('Please enter APT/STE/#.');
      // if (this.keywordsInput.basicInfoFormObj.controls['apt'].invalid) {
      const aptcontrol = this.el.nativeElement.querySelector('[formcontrolname="' + "apt" + '"]');
      aptcontrol.focus();
      // }
      window.scrollTo(0, 0); // this will scroll page to the top
      return;
    }
    else if (this.candData.cityName.trim() == '') {
      this.toastr.error('Please enter City name.');
      // if (this.keywordsInput.basicInfoFormObj.controls['cityName'].invalid) {
      const cityNamecontrol = this.el.nativeElement.querySelector('[formcontrolname="' + "cityName" + '"]');
      cityNamecontrol.focus();
      // }
      window.scrollTo(0, 0); // this will scroll page to the top
      return;
    }
    else if (this.candData.stateName.trim() == '') {
      this.toastr.error('Please enter State name.');
      // if (this.keywordsInput.basicInfoFormObj.controls['stateName'].invalid) {
      const stateNamecontrol = this.el.nativeElement.querySelector('[formcontrolname="' + "stateName" + '"]');
      stateNamecontrol.focus();
      // }
      window.scrollTo(0, 0); // this will scroll page to the top
      return;
    }
    else if (this.candData.countryName.trim() == '') {
      this.toastr.error('Please enter country name.');
      // if (this.keywordsInput.basicInfoFormObj.controls['countryName'].invalid) {
      const countryNamecontrol = this.el.nativeElement.querySelector('[formcontrolname="' + "countryName" + '"]');
      countryNamecontrol.focus();
      // }
      window.scrollTo(0, 0); // this will scroll page to the top
      return;
    }
    else if (this.candData.zipcode.trim() == '') {
      this.toastr.error('Please enter zipcode.');
      // if (this.keywordsInput.basicInfoFormObj.controls['zipcodeName'].invalid) {
      const zipcodeNamecontrol = this.el.nativeElement.querySelector('[formcontrolname="' + "zipcode" + '"]');
      zipcodeNamecontrol.focus();
      // }
      window.scrollTo(0, 0); // this will scroll page to the top
      return;
    }
    ...
    if (!this.firstNameStatus) {
      ...
      if (this.keywordsInput.basicInfoFormObj.controls['firstName'].invalid) {
      ...
      if (this.keywordsInput.basicInfoFormObj.controls['lastName'].invalid) {
      ...
      if (this.keywordsInput.basicInfoFormObj.controls['email'].invalid) {
    ...
    else if (!this.addressLineStatus) {
      this.toastr.error('Please enter Address Line 1.');
      if (this.keywordsInput.basicInfoFormObj.controls['address'].invalid) {
        const addresscontrol = this.el.nativeElement.querySelector('[formcontrolname="' + "address" + '"]');
        addresscontrol.focus();
    ...
    if (this.candData.firstName.trim() && this.candData.lastName.trim() && this.candData.email.trim()) {
      localStorage.setItem("isUploadResumeStatus", "2");
      localStorage.setItem("locationfromCreateUploadResume", "1");
      this.staticAuditLogAPI('66', '');
